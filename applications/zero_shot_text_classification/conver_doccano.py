...
class DoccanoDataConverter(object):
    """
    ...
    def __init__(self, options, text_separator):
        ...
        elif isinstance(options,str) and os.path.isfile(options):
    ...
    def convert_utc_examples(self, raw_examples):
        ...
        for example in raw_examples:
            ...
            if "data" in items.keys():
                raw_text, labels = items["data"], items["label"]
            else:
                raw_text, labels = items["text"], items["label"]
            label_list = []
...
def do_convert():
    ...
    data_converter = DoccanoDataConverter(args.options, args.text_separator)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--label_studio_file", default="./data/label_doccano.json", type=str, help="The annotation file exported from label studio platform.")
    ...
    parser.add_argument("--options", default="./data/label_doccano.txt", type=str, nargs="+", help="The options for classification.")
